...
\author{Bobak Farzin \inst{1}$^{*}$ Piotr Czapla \inst{2}\thanks{BF was the primary researcher. PC contributed with suggestions for the random seeds as a hyper-parameters and label smoothing to speed up training. JH contributed with suggestion for higher dropout throughout the network for more generalization.} and Jeremy Howard\inst{3}$^{*}$ \\June 2019}
%
...
\and  
University of San Francisco \& Fast.ai\\ \email{j@fast.ai}}
